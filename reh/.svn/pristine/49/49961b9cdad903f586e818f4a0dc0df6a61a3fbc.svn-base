$(function(){
	...
	//初始化表格
    $.reeTable({
        'dataSource': 'Favourite_Get_By_EntNo',
        'dataTitle': [
                      {
        	...
        	'userAddrName',
        	{
        	'id': 'userNo','sub_id':'jobNo','format': 
        		'<a class="recruitJob_btn" href="#" data-action="Favourite_Del?userBean.userNo=*&jobBean.jobNo=^">移出收藏夹</a> '
