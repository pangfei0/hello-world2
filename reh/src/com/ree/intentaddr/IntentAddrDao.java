...
public class IntentAddrDao {

	private String query_statement = null;
	private List<RepAdminIntentAddrDict> list = null;
	private SessionHelper s = new SessionHelper();
	private RepAdminIntentAddrDict cbean;

	public IntentAddrDao() {
	...
	* @return
	 */
	public List<RepAdminIntentAddrDict> GetAddr_By_father_id(int communityFatherNo){
		List<RepAdminIntentAddrDict> list = new ArrayList<RepAdminIntentAddrDict>();
		query_statement = "from com.ree.hibernate.RepAdminIntentAddrDict where intentFatherNo =? and intentAddrNo !=0";
	...
	* @return
	...
	public RepAdminIntentAddrDict GetAddr_By_id(int communityNo) throws SQLException{
		query_statement = "from com.ree.hibernate.RepAdminIntentAddrDict where intentAddrNo = ?";
	...
	/**
	 */
	public List<RepAdminIntentAddrDict> GetAddr_By_All(){
		List<RepAdminIntentAddrDict> list = new ArrayList<RepAdminIntentAddrDict>();
		query_statement = "from com.ree.hibernate.RepAdminIntentAddrDict ";
	...
	* @return
	 */
	public String  UpdateIntentAddr_By_Bean( RepAdminIntentAddrDict b){
		
			String rs=null;
			try {
				s.Update(b);
				s.runProc_one_int_parma("{call update_intent_range(?)}", b.getIntentAddrNo());
			} catch (Exception e) {
				rs += e.getMessage();
	...
	* @return
	 */
	public String AddIntentAddr_By_Bean(RepAdminIntentAddrDict b){
	...
	* @return
	 */
	public String DelIntentAddr_By_Bean(int id){
	
		String rs = null;
		try {
			s.Delete(s.getBean(RepAdminIntentAddrDict.class, id));
		} catch (Exception e) {
			rs += e.getMessage();
			// TODO Auto-generated catch block
			e.printStackTrace();
