	...
	<div id="cl-wrapper" class="login-container">
		...
		<div class="middle-login">
			<div class="block-flat">
				...
				<div>
					<form style="margin-bottom: 0px !important;" class="form-horizontal" action="EntFindpassAction" method="post">
						<div class="content">
							...
							<div class="form-group">
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" placeholder="请输入企业名" id="username" data-title="用户名/邮箱"
							...
							<div class="form-group">
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" placeholder="请输入企业邮箱" id="email" data-title="邮箱"
						...
						<div class="foot">
						    <a class="btn btn-default findpass"  data-dismiss="modal" href="login.jsp"
								>返回登录</a>
