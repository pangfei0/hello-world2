...
$(".tcdPageCode").createPage({
    ...
    backFn:function(c){
    	...
    	$.post("I_toTrain_byNewNoAndUserNo.action",{"listno":6,"c":c,"p":10,"orderField":"newsTitle","orderDirection":"desc","keyword":""},function(d){	
    		for ( var i in d.store.data) {
    			...
    			'<td>'+ '<a href="trainAction?news_id='+d.store.data[i].newsNo+'&user_id='+userno+'&submittime='+d.store.data[i].newsSubmittime+'">报名培训</a>'+ '</td>'
    			+'</tr>'
			}
